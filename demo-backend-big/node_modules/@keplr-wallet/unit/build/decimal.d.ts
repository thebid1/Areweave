...
export declare class Dec {
    ...
    static readonly precisionMultipliers: Map<string, bigInteger.BigInteger>;
    ...
    static readonly zero: Dec;
    /** Smallest `Dec` with current precision. */
    static readonly smallestDec: Dec;
    static readonly one: Dec;
     ...
     */
    constructor(int: bigInteger.BigNumber | Int | Uint, prec?: number);
    ...
    pow(n: Int): Dec;
    approxSqrt(): Dec;
    approxRoot(root: number, maxIters?: number): Dec;
    mul(d2: Dec): Dec;
    mulTruncate(d2: Dec): Dec;
    mulRoundUp(d2: Dec): Dec;
    ...
    round(): Int;
    roundTo(decimalPlace: number): Dec;
    roundUp(): Int;
    truncate(): Int;
    roundDec(): Dec;
    roundUpDec(): Dec;
