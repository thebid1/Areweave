...
describe("Test decimals", () => {
    ...
    it("Test Dec approxRoot", () => {
        const tests = [
            ...
            { d: new decimal_1.Dec(1, 8), r: 3, res: new decimal_1.Dec("0.002154434690031900") }, // 1e-8 ^ (1/3) ≈ 0.00215443469
        ];
        for (const test of tests) {
    ...
    it("dec should be round to decimal place properly", () => {
        const tests = [
            ...
            {
                d1: new decimal_1.Dec("0.123456"),
                exp: new decimal_1.Dec("0.123"),
                decimalPlace: 4,
            },
            {
                d1: new decimal_1.Dec("1"),
            ...
            {
                d1: new decimal_1.Dec("0.75"),
                exp: new decimal_1.Dec("0.8"),
                decimalPlace: 2,
            },
            {
                d1: new decimal_1.Dec("0.53"),
                exp: new decimal_1.Dec("0.5"),
                decimalPlace: 2,
            },
            {
                d1: new decimal_1.Dec("7.5997"),
                exp: new decimal_1.Dec("7.6"),
                decimalPlace: 4,
            },
            {
                d1: new decimal_1.Dec("0.545"),
            ...
            {
                d1: new decimal_1.Dec("1.545"),
                exp: new decimal_1.Dec("1.55"),
                decimalPlace: 3,
            },
            {
                d1: new decimal_1.Dec("0.545123"),
                exp: new decimal_1.Dec("0.5451"),
                decimalPlace: 5,
            },
            {
                d1: new decimal_1.Dec("0.123456789123456789"),
                exp: new decimal_1.Dec("0.12345678912345679"),
                decimalPlace: 18,
            },
            {
                d1: new decimal_1.Dec("0.123456789123456789"),
                exp: new decimal_1.Dec("0.123456789123456789"),
                decimalPlace: 19,
            },
        ];
        for (const test of tests) {
