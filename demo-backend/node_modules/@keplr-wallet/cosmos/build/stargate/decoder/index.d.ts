import { AuthInfo, SignDoc, SignDocDirectAux, TxBody } from "@keplr-wallet/proto-types/cosmos/tx/v1beta1/tx";
import { AnyWithUnpacked, ProtoCodec } from "../codec";
export declare class ProtoSignDocDecoder {
    readonly signDoc: SignDoc | SignDocDirectAux;
    ...
    constructor(signDoc: SignDoc | SignDocDirectAux, protoCodec?: ProtoCodec);
    get txBody(): TxBody;
